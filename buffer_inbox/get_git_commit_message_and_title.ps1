...
# Example(4): grep match many patterns, Logical-OR: ie: update OR data
git --no-pager log --oneline --grep="update" --grep="data"

# Example(5): grep match many patterns, Logical-AND: ie: update AND data
git --no-pager log --oneline --grep="update" --grep="data" --all-match
